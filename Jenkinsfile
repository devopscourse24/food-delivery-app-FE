 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t elfn/food-delivery-app:${VERSION} .'
          sh 'docker push elfn/food-delivery-app:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: elfn\\/food-delivery-app:${VERSION}/" aws/angular-manifest.yaml
        '''
